...
logger = setup_logging("ChatTriggerNode", level="DEBUG")


@register_node("ChatTriggerNode")
class ChatTriggerNode(BaseNode):
    is_trigger_node = True

    def execute(self, inputs: Dict[str, Any]) -> Dict[str, Any]:
        logger.info(f"[CHAT_TRIGGER] Executing node={self.node_id}")
